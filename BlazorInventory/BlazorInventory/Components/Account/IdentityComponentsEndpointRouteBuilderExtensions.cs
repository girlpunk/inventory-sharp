...
using BlazorInventory.Components.Account.Pages;
using BlazorInventory.Components.Account.Pages.Manage;
    ...
    public static IEndpointConventionBuilder MapAdditionalIdentityEndpoints(this IEndpointRouteBuilder endpoints)
    {
            ...
            [FromServices] AuthenticationStateProvider authenticationStateProvider) =>
        {
            ...
            var personalDataProps = typeof(ApplicationUser)
                .GetProperties()
                .Where(static prop => Attribute.IsDefined(prop, typeof(PersonalDataAttribute)));
